...
export default function MatiereParClasse({navigation,route}){
...
const {item} = route.params;
  ...
  useEffect(()=>{
    navigation.setOptions({ title: item.intitule_classe });
  ...
  const getMatiere = async () => {
    setIsLoading(true);
   try {
    const response = await fetch(`https://adores.tech/api/data/liste-matiere-classe.php?classe=${item.code_classe}`, {
      headers: {
