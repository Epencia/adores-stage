...
export default function MatiereMaster2({navigation,item}){
  ...
  const getMatiere = async () => {
    setIsLoading(true);
   try {
    const response = await fetch(`https://adores.tech/api/data/liste-matiere-master2.php?matricule=${user[0].matricule}`, {
      headers: {
