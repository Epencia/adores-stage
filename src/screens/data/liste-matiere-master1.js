...
export default function MatiereMaster1({navigation,item}){
  ...
  const getMatiere = async () => {
    setIsLoading(true);
   try {
    const response = await fetch(`https://adores.tech/api/data/liste-matiere-master1.php?matricule=${user[0].matricule}`, {
      headers: {
