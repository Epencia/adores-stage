...
export default function FoireAuxQuestions({navigation}){
...
useEffect(()=>{
navigation.setOptions({title: 'Foire aux questions'});
...
const getFoireAuxQuestions = async () => {
  setIsLoading(true);
 try {
  const response = await fetch(`https://adores.tech/api/data/liste-faq.php`, {
    headers: {
